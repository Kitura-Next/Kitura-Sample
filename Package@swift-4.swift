...
dependencies.append(.package(url: "https://github.com/Kitura-Next/appid-serversdk-swift", from: "5.1.0"))
...
if ProcessInfo.processInfo.environment["KITURA_NIO"] != nil {
    dependencies.append(.package(url: "https://github.com/Kitura-Next/Kitura-WebSocket-NIO.git", from: "1.0.0"))
} else {
